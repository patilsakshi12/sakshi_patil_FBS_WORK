    ...
    public static void main(String args[]) {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 7:
                    ArrayList<Employee> emps = dao.getAllEmployee();
                    for (Employee e : emps) {
                        if (e != null) {
